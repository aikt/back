...
class EmbedFacebookController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Embed de Facebook';
    ...
    {
        $grid = new Grid(new EmbedFacebook());
    ...
    {
        $show = new Show(EmbedFacebook::findOrFail($id));
    ...
    {
        $form = new Form(new EmbedFacebook());
